...
namespace WebApplication22_1.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Heading,Text")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Heading,Text")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
